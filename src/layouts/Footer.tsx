...
export default function Footer() {
  return (
    <footer className="border-t border-white/10 bg-primary/40">
        ...
        <div className="grid gap-10 md:grid-cols-12">
          <div className="md:col-span-5">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-lg font-bold text-white">{business.name}</div>
                <div className="text-sm text-white/70">Premium patio cleaning</div>
              </div>
            </div>

            <p className="mt-4 text-sm leading-relaxed text-white/75">
              Deep outdoor cleaning across the UK. We remove moss, algae, dirt and
              staining for a safer, brighter finish.
            </p>

            <div className="mt-6 flex flex-wrap items-center gap-3">
              <a
                href={`tel:${business.telephone}`}
                className="inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/5 px-4 py-2 text-sm font-semibold text-white/90 transition hover:bg-white/10"
              >
          ...
          <div className="md:col-span-4">
            <div className="text-sm font-bold text-white">Follow</div>
            <p className="mt-4 text-sm leading-relaxed text-white/75">
              Recent before/after transformations and quick outdoor cleaning
              tips.
            </p>
