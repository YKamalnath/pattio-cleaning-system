    ...
    <div className={cn("relative overflow-hidden rounded-3xl", className)}>
      <div className="relative h-[320px] w-full sm:h-[400px]">
        ...
        <div className="absolute inset-0">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-t from-brandBlue/50 via-black/10 to-transparent" />
        </div>
        ...
        {/* Divider */}
        <div
          className="absolute top-0 bottom-0 w-px bg-white/70 shadow-[0_0_0_1px_rgba(255,255,255,0.25)]"
          style={{ left: `${value}%` }}
        />
        ...
        >
          <div className="flex items-center gap-2 rounded-full bg-brandBlue/90 px-3 py-2 ring-1 ring-white/15 backdrop-blur">
            <span className="flex items-center text-xs font-bold text-white">
              <Minus className="h-4 w-4 text-brandGreen" />
        ...
        {/* Labels */}
        <div className="absolute left-4 top-4 rounded-2xl bg-black/30 px-3 py-2 text-xs font-bold text-white/90 backdrop-blur">
          {beforeLabel}
        </div>
        <div className="absolute right-4 top-4 rounded-2xl bg-brandGreen/20 px-3 py-2 text-xs font-bold text-white/90 backdrop-blur ring-1 ring-brandGreen/25">
          {afterLabel}
        </div>
